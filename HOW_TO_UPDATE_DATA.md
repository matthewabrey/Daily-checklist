...
### Update Staff
```bash
curl -X POST https://checklist-capture.preview.emergentagent.com/api/admin/update-staff \
...
### Update Assets
```bash
curl -X POST https://checklist-capture.preview.emergentagent.com/api/admin/update-assets \
  -H "Content-Type: application/json" \
