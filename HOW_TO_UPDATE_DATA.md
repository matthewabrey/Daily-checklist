...
### Update Staff
```bash
curl -X POST https://repairflow-20.preview.emergentagent.com/api/admin/update-staff \
...
### Update Assets
```bash
curl -X POST https://repairflow-20.preview.emergentagent.com/api/admin/update-assets \
  -H "Content-Type: application/json" \
