...
### Update Staff
```bash
curl -X POST https://safeguard-hub-27.preview.emergentagent.com/api/admin/update-staff \
...
### Update Assets
```bash
curl -X POST https://safeguard-hub-27.preview.emergentagent.com/api/admin/update-assets \
  -H "Content-Type: application/json" \
