...
### Update Staff
```bash
curl -X POST https://machinehealth-2.preview.emergentagent.com/api/admin/update-staff \
...
### Update Assets
```bash
curl -X POST https://machinehealth-2.preview.emergentagent.com/api/admin/update-assets \
  -H "Content-Type: application/json" \
