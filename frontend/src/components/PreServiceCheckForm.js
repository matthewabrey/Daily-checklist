...
const AddSectionRow = ({ onAdd, generic }) => {
  ...
  return (
    <Card className={`p-4 border-dashed ${generic ? 'border-green-300 bg-green-50/30' : 'border-gray-300'}`} data-testid="add-service-section-card">
...
export const PreServiceCheckForm = ({
  ...
  <div className="space-y-4" data-testid="pre-service-check-form">
    ...
    <Card className="p-4 border-green-200 bg-green-50/40" data-testid="other-parts-issues-card">
      <h4 className="text-base font-semibold text-green-900">Any other Parts or Issues</h4>
